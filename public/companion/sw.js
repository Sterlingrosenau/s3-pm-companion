const CACHE_NAME = "s3-pmp-v3-3000";
const APP_FILES = ["./", "./index.html", "./styles.css", "./app.js", "./data/questions.js", "./manifest.webmanifest", "./icons/icon.svg", "./icons/icon-192.png", "./icons/icon-512.png"];
